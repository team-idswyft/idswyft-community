...
| Voice Authentication | 512-d speaker embeddings (CAM++ model), ASR digit transcription (Whisper), cosine similarity matching, random challenge anti-spoofing, configurable threshold (0.55 prod / 0.50 sandbox) |
