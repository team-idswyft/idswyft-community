...
// ─── Shared presentational atoms (same visual DNA as DocsPage) ───────────────
...
const Callout = ({ type = 'note', children }: { type?: 'note' | 'warning' | 'tip'; children: React.ReactNode }) => {
  const cfg = {
    ...
    <div className="pattern-wave pattern-faint pattern-fade-edges pattern-full" style={{ fontFamily: C.sans, background: C.bg, color: C.text, margin: '-24px -24px 0', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <div style={{ borderBottom: `1px solid ${C.border}`, padding: '18px 32px', display: 'flex', alignItems: 'center', gap: 16, position: 'sticky', top: 0, background: `${C.bg}ee`, backdropFilter: 'blur(8px)', zIndex: 10 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <Link to="/docs" style={{ color: C.muted, display: 'flex', alignItems: 'center', textDecoration: 'none', transition: 'color 0.15s' }} onMouseEnter={e => (e.currentTarget.style.color = C.cyan)} onMouseLeave={e => (e.currentTarget.style.color = C.muted)}>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 8, alignItems: 'center' }}>
          <Link to="/docs" style={{ fontFamily: C.mono, fontSize: '0.72rem', fontWeight: 500, color: C.muted, textDecoration: 'none', padding: '4px 10px', borderRadius: 6, border: `1px solid ${C.border}`, transition: 'color 0.15s, border-color 0.15s' }}
      ...
      <div style={{ display: 'flex', maxWidth: 1440, margin: '0 auto' }}>
        ...
        <main style={{ flex: 1, padding: '48px 52px', maxWidth: 980, minWidth: 0 }}>
          ...
          {/* ── Footer ── */}
          <div style={{ marginTop: 64, paddingTop: 24, borderTop: `1px solid ${C.border}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
            <span style={{ fontFamily: C.mono, fontSize: '0.7rem', color: C.dim }}>
              &copy; 2026 Idswyft &mdash; Open source under MIT License
            </span>
            <Link to="/docs" style={{ fontFamily: C.mono, fontSize: '0.75rem', color: C.cyan, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 6 }}>
