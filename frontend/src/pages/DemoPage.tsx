          ...
          <div style={{ padding: '8px 0' }}>
            ...
            {!addressResult ? (
              <div style={{ maxWidth: 420, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <label htmlFor="address-doc-upload" style={{ display: 'block', border: `2px dashed ${C.border}`, borderRadius: 8, padding: '32px 16px', textAlign: 'center', cursor: 'pointer' }}>
                  <input type="file" accept="image/jpeg,image/png,application/pdf" onChange={handleAddressFileSelect} style={{ display: 'none' }} id="address-doc-upload" />
                  <svg style={{ width: 40, height: 40, margin: '0 auto 12px', color: C.muted }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                  </svg>
                ...
                {addressFile && (
                  <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: 8, padding: 16 }}>
                    ...
                    {addressPreview && (
                      <img src={addressPreview} alt="Address document preview" style={{ width: '100%', height: 160, objectFit: 'contain', background: C.codeBg, borderRadius: 6, marginTop: 12 }} />
                    )}
                  </div>
                )}
                ...
                {addressFile && (
                  <button
                    ...
                    style={{ background: C.purple, color: '#fff', border: 'none', borderRadius: 8, padding: '11px 0', width: '100%', fontWeight: 600, fontSize: 14, cursor: addressUploading ? 'not-allowed' : 'pointer', opacity: addressUploading ? 0.5 : 1 }}
                  >
                ...
                <button
                  ...
                  style={{ background: 'transparent', color: C.muted, border: `1px solid ${C.border}`, borderRadius: 8, padding: '10px 0', fontWeight: 500, fontSize: 13, cursor: 'pointer' }}
                >
                  Skip — Start New Demo
                </button>
              </div>
              ...
              <div style={{ maxWidth: 420, margin: '0 auto' }}>
                {/* Address Result Card */}
                <div style={{
                  background: C.surface, border: `1px solid ${C.border}`, borderRadius: 8, padding: 20, marginBottom: 20,
                }}>
                  ...
                  {addressResult.reasons && addressResult.reasons.length > 0 && (
                    <div style={{ marginTop: 12, background: C.codeBg, borderRadius: 6, padding: 10 }}>
                ...
                <button
                  ...
                  style={{ background: C.cyan, color: C.bg, border: 'none', borderRadius: 8, padding: '10px 24px', fontWeight: 600, fontSize: 14, cursor: 'pointer', width: '100%' }}
                >
                  Start New Demo
                </button>
              </div>
